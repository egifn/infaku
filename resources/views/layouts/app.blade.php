      ...
      <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <div class="menu-item has-submenu" data-submenu="achievment">
              <i class="eg-document"></i><span class="menu-text">Master</span><span class="dropdown-toggle">▶</span>
            </div>
            <div id="achievment" class="submenu">
              <a href="{{ route('admin.achievment.area') }}" class="menu-item {{ request()->routeIs('admin.achievment.area') ? 'active' : '' }}">
                <span class="menu-text">Wilayah</span>
              </a>
              <a href="{{ route('admin.achievment.supplier') }}" class="menu-item {{ request()->routeIs('admin.achievment.supplier') ? 'active' : '' }}">
                <span class="menu-text">Supplier</span>
              </a>
              <a href="{{ route('admin.achievment.principle') }}" class="menu-item {{ request()->routeIs('admin.achievment.principle') ? 'active' : '' }}">
                <span class="menu-text">Principle</span>
              </a>
              <a href="{{ route('admin.achievment.depo') }}" class="menu-item {{ request()->routeIs('admin.achievment.depo') ? 'active' : '' }}">
                <span class="menu-text">Depo</span>
              </a>
            </div>
            <a href="{{ route('admin.historymovement') }}" class="menu-item {{ request()->routeIs('admin.historymovement') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.leadtime') }}" class="menu-item {{ request()->routeIs('admin.leadtime') ? 'active' : '' }}">
                <i class="eg-document"></i>
